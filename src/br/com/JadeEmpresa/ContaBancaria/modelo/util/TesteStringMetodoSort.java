...
public class TesteStringMetodoSort {
    ...
    public static void main(String[] args) {
        ...
        ComparadoListaNumero comparadoListaNumero = new ComparadoListaNumero();
        ComparadorDeStrings comparadorDeStrings = new ComparadorDeStrings();


        lista.sort(comparadorDeStrings);
    ...
    static class ComparadorDeStrings implements Comparator<Conta>{
    ...
    static class ComparadoListaNumero implements Comparator<Conta> {
