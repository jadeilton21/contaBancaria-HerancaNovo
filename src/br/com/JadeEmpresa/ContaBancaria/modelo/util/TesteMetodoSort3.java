...
public class TesteMetodoSort3 {
    ...
    public static void main(String[] args) {
        ...
        double jade = cc3.deposita(111.0);
        ...
        AnotacaoMedoto anotacaoMedoto = new AnotacaoMedoto();


        lista.sort(anotacaoMedoto);
    ...
    static class AnotacaoMedoto implements Comparator<Conta> {
