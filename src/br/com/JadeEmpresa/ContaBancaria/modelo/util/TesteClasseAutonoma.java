...
public class TesteClasseAutonoma {public static void main(String[] args) {
    ...
    lista.sort(new Comparator<Conta>() { // Classe Autonoma
    ...
    for (Conta conta : lista) {
        System.out.println(conta + " Nome: " + conta.getTitluar());
    }
