...
public class TesteMetodoSort2 {
    ...
    public static void main(String[] args) {
        ...
        NomeOrdenandoAlista ordenandoAlista = new NomeOrdenandoAlista();

        lista.sort(ordenandoAlista);
    ...
    static class NomeOrdenandoAlista implements Comparator<Conta> {
